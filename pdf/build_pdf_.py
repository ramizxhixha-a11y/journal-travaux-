...
def draw_page_de_garde(c, p):
    ...
    draw_eeg_cachet(c, W - MARGIN_R - 90, y + 25, scale=0.7)
...
def draw_page_identification(c, p):
    ...
    # Cachet EEG en bas à droite — taille identique à l'en-tête des folios (0.78),
    # bord inférieur juste au-dessus de la ligne de pied de page de gauche
    draw_eeg_cachet(c, W - MARGIN_R - 90, H - MARGIN_B - 88, scale=0.78)

    # Pied de page
    c.setFont(F_IT, 7)
    c.drawString(MARGIN_L, yt(H - MARGIN_B - 5),
                 "Page d'identification — Journal des Travaux EEG")
